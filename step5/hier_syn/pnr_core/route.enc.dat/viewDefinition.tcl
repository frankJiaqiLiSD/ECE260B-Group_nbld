...
create_library_set -name WC_LIB\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/sram_2ports_WC.lib\
    ${::IMEX::libVar}/mmmc/sfp_row_WC.lib\
    ${::IMEX::libVar}/mmmc/mac_array_WC.lib]
create_library_set -name BC_LIB\
   -timing\
    [list ${::IMEX::libVar}/mmmc/tcbn65gplusbc.lib\
    ${::IMEX::libVar}/mmmc/sram_w16_BC.lib\
    ${::IMEX::libVar}/mmmc/sram_2ports_BC.lib\
    ${::IMEX::libVar}/mmmc/sfp_row_BC.lib\
    ${::IMEX::libVar}/mmmc/mac_array_BC.lib]

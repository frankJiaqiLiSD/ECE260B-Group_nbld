...
# ============================================================
# Hierarchical Synthesis: SRAM modules are black boxes (no .db)
...
# Read RTL - all non-blackbox sub-modules (flat within core)
# Black boxes (NOT read): sram_w16, sram_2ports, sfp_row
# These have their own PnR — .lib/.lef used in core PnR stage
...
set_driving_cell -lib_cell BUFFD8 -pin Z [remove_from_collection [all_inputs] [get_ports clk]]

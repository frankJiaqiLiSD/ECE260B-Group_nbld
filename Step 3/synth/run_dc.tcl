...
# read RTL
analyze -format verilog -lib WORK "submodule1.v"
analyze -format verilog -lib WORK "submodule2.v"
analyze -format verilog -lib WORK "modulename.v"

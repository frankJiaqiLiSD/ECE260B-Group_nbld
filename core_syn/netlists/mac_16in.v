...
reg signed 	[2*bw-1:0]	psum0_reg;
reg signed 	[2*bw-1:0]	psum1_reg;
reg signed 	[2*bw-1:0]	psum2_reg;
reg signed 	[2*bw-1:0]	psum3_reg;
...
// Added 4 pipelines
assign out = psum0_reg + psum1_reg + psum2_reg + psum3_reg;
...
always @ (posedge clk) begin
	if (reset) begin
		...
		psum1_reg <={{(4){product4_reg[2*bw-1]}},product4_reg}

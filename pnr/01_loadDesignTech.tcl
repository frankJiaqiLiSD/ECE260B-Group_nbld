...
set init_lef_file $lef "./subckt/submodule.lef"

# MCMM setup
create_library_set -name WC_LIB -timing $worst_timing_lib "./subckt/submodule_WC.lib"
create_library_set -name BC_LIB -timing $best_timing_lib "./subckt/submodule_BC.lib"
